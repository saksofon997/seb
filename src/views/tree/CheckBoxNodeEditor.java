...
public Object getCellEditorValue() {
	...
	//final DefaultMutableTreeNode test = (DefaultMutableTreeNode) theTree.getLastSelectedPathComponent();
	final CheckBoxNode node =
		new CheckBoxNode(renderer.getObjekat().getPar(), panel.check.isSelected());
	return node;
}
...
public boolean isCellEditable(final EventObject event) {
	...
	return userObject instanceof CheckBoxNode;
}
